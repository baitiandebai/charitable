...
(function(a){
    a.fn.scroller_roll=function(p){
        ...
        if(y.find("ul").length==0||a("li").length==0){
            ...
            y.children("ul").children("li").children("span").children("img").css("width",m).css("height",n);
        if(h=='enable'){
            y.children("ul").children("li").children("span").each(function(){
        ...
        y.children("ul").children("li").children("span").css("color",q);
        y.children("ul").children("li").children("span").css("font-size",o);
        y.hover(function(){
            stop()
            },function(){
            play()
